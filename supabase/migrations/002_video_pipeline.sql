...
VALUES
    ('001', '80.V0B',      'Long',  'Health Info & Biology Baseline',                                    'Uploaded',              '2026-08-17', '2026-07-26', '80.10', 'Level 1: FMR', 'Published'),
    ('002', '80.V0A',      'Long',  '230,000 Patient Visits',                                            'Uploaded',              '2026-08-03', '2026-07-26', '80.10', 'Baseline',     'Published'),
    ...
    ('005', '80.V0B-S1',   'Short', 'Why Health Information Alone Keeps You Broken',                     'Editing',               '2026-08-18', NULL,         '42.02', 'Level 1: FMR', '6/6 Shots Filmed — Editing (#edit)'),
    ('006', '80.V0B-S2',   'Short', 'The Hidden System Glitch Ruining Your Body',                        'Ready for Audio Riff',  '2026-08-20', NULL,         '77.03', 'Level 1: FMR', 'Pre-Recording Blueprint Ready'),
    ('007', '80.V0B-S3',   'Short', 'Stop Buying Health Advice from Coaches Who Dont Know Physiology',   'Ready for Audio Riff',  '2026-08-22', NULL,         '77.01', 'Level 1: FMR', 'Pre-Recording Blueprint Ready'),
    ('008', '80.V0A-S1',   'Short', 'The Biological Reason Monday Resolutions Always Fail',              'Editing',               '2026-08-04', NULL,         '41.03', 'Level 1: FMR', '6/6 Shots Filmed — Editing (#edit)'),
    ('009', '80.V0A-S2',   'Short', 'The Exact Biological Sequence Your Body Needs to Change',           'Editing',               '2026-08-06', NULL,         '42.04', 'Level 1: FMR', '6/6 Shots Filmed — Editing (#edit)'),
    ('010', '80.V0A-S3',   'Short', 'Stop Treating Your Health Like an Emergency Room',                  'Editing',               '2026-08-08', NULL,         '77.02', 'Level 1: FMR', '6/6 Shots Filmed — Editing (#edit)'),
