...
PIPELINE_SEED = [
    {"video_number": "001", "code": "80.V0B",     "format_type": "Long",  "title": "Knowledge Isn't Enough—Here's What Actually Works",       "status": "#published",           "drop_date": "2026-08-03", "uploaded_date": "2026-07-26", "jdex_code": "80.10", "os_level": "Level 1: FMR", "notes": "Published"},
    {"video_number": "002", "code": "80.V0A",     "format_type": "Long",  "title": "230,000 Patient Visits",                                          "status": "#published",           "drop_date": "2026-08-17", "uploaded_date": "2026-07-26", "jdex_code": "80.10", "os_level": "Baseline",     "notes": "Published"},
    {"video_number": "003", "code": "80.V1B1",    "format_type": "Long",  "title": "Exercise Optional (Movement Mandatory)",                           "status": "#published",           "drop_date": "2026-08-10", "uploaded_date": "2026-07-26", "jdex_code": "77.01", "os_level": "Level 1: FMR", "notes": "Published"},
    {"video_number": "004", "code": "80.V0A1",    "format_type": "Long",  "title": "Systemized OS Framework",                                         "status": "#edit",                "drop_date": "2026-08-24", "uploaded_date": None,         "jdex_code": "81.05", "os_level": "Level 1: FMR", "notes": "Currently Editing"},
    {"video_number": "005", "code": "80.V0B-S1",  "format_type": "Short", "title": "Why Health Information Alone Keeps You Broken",                   "status": "#edit",                "drop_date": "2026-08-04", "uploaded_date": None,         "jdex_code": "42.02", "os_level": "Level 1: FMR", "notes": "6/6 Shots Filmed — Editing (#edit)"},
    {"video_number": "006", "code": "80.V0B-S2",  "format_type": "Short", "title": "The Hidden System Glitch Ruining Your Body",                      "status": "#write",               "drop_date": "2026-08-06", "uploaded_date": None,         "jdex_code": "77.03", "os_level": "Level 1: FMR", "notes": "Pre-Recording Blueprint Ready"},
    {"video_number": "007", "code": "80.V0B-S3",  "format_type": "Short", "title": "Stop Buying Health Advice from Coaches Who Dont Know Physiology",  "status": "#write",               "drop_date": "2026-08-08", "uploaded_date": None,         "jdex_code": "77.01", "os_level": "Level 1: FMR", "notes": "Pre-Recording Blueprint Ready"},
    {"video_number": "008", "code": "80.V0A-S1",  "format_type": "Short", "title": "The Biological Reason Monday Resolutions Always Fail",             "status": "#edit",                "drop_date": "2026-08-18", "uploaded_date": None,         "jdex_code": "41.03", "os_level": "Level 1: FMR", "notes": "6/6 Shots Filmed — Editing (#edit)"},
    {"video_number": "009", "code": "80.V0A-S2",  "format_type": "Short", "title": "The Exact Biological Sequence Your Body Needs to Change",          "status": "#edit",                "drop_date": "2026-08-20", "uploaded_date": None,         "jdex_code": "42.04", "os_level": "Level 1: FMR", "notes": "6/6 Shots Filmed — Editing (#edit)"},
    {"video_number": "010", "code": "80.V0A-S3",  "format_type": "Short", "title": "Stop Treating Your Health Like an Emergency Room",                 "status": "#edit",                "drop_date": "2026-08-22", "uploaded_date": None,         "jdex_code": "77.02", "os_level": "Level 1: FMR", "notes": "6/6 Shots Filmed — Editing (#edit)"},
    {"video_number": "011", "code": "80.V1B1-S1", "format_type": "Short", "title": "Why Exercise is Optional",                                         "status": "#write",               "drop_date": "2026-08-11", "uploaded_date": None,         "jdex_code": "77.01", "os_level": "Level 1: FMR", "notes": "Pre-Recording Blueprint Ready"},
    {"video_number": "012", "code": "80.V1B1-S2", "format_type": "Short", "title": "Joint Imbibition: The Only Way Your Joints Actually Get Nourished", "status": "#write",               "drop_date": "2026-08-13", "uploaded_date": None,         "jdex_code": "77.01", "os_level": "Level 1: FMR", "notes": "Pre-Recording Blueprint Ready"},
    {"video_number": "013", "code": "80.V1B1-S3", "format_type": "Short", "title": "Cortical Smudging: Why Your Back Pain Randomly Spasms",            "status": "#write",               "drop_date": "2026-08-15", "uploaded_date": None,         "jdex_code": "77.03", "os_level": "Level 1: FMR", "notes": "Pre-Recording Blueprint Ready"},
    {"video_number": "014", "code": "80.V0A1-S1", "format_type": "Short", "title": "Why Relying on Willpower Guarantees Physical Burnout",             "status": "#edit",                "drop_date": "2026-08-25", "uploaded_date": None,         "jdex_code": "42.06", "os_level": "Level 1: FMR", "notes": "6/6 Shots Filmed — Editing (#edit)"},
    {"video_number": "015", "code": "80.V0A1-S2", "format_type": "Short", "title": "The Level 1 FMR Baseline Every Body Needs to Master",              "status": "#edit",                "drop_date": "2026-08-27", "uploaded_date": None,         "jdex_code": "81.05", "os_level": "Level 1: FMR", "notes": "6/6 Shots Filmed — Editing (#edit)"},
    {"video_number": "016", "code": "80.V0A1-S3", "format_type": "Short", "title": "The 3-Tier Health Pyramid That Fixes Chronic Fatigue",             "status": "#edit",                "drop_date": "2026-08-29", "uploaded_date": None,         "jdex_code": "43.11", "os_level": "Level 1: FMR", "notes": "6/6 Shots Filmed — Editing (#edit)"},
]
...
def seed_db():
    ...
    for v in PIPELINE_SEED:
        ...
        if result:
            ...
            if v["status"] not in ["#uploaded", "#published"]:
                video_id = result["id"]
