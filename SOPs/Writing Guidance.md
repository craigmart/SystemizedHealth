...
- **Clip Sub-Code Standard (`[VideoCode]>[ClipNumber]`)**: In Stage 2 Teleprompter scripts, every clip block MUST begin with a dedicated clip sub-code header (e.g. `### Clip 80.V0A-S1>1 — The Hook #film #insidetruck`). When recording, Dr. Anderson saves each video file using this exact clip sub-code (e.g., `80.V0A-S1>1.mp4`, `80.V0A-S1>2.mp4`) so sorting the destination folder automatically arranges the clips in correct assembly order.
